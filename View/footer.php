  ...
  <div class="container footer-grid">
    <div>
      <div class="footer-brand">
        <div class="logo-circle footer-logo-circle">🏫</div>
        <div>
          <div class="footer-brand-name">Wellucation</div>
          <div class="footer-brand-tagline">Learn. Play. Grow</div>
        </div>
      </div>
    ...
    <div>
      ...
      <div class="footer-hours-box">
        <p class="footer-hours-title">School Hours</p>
        <p class="footer-hours-text">Mon – Fri: 7:00 AM – 6:00 PM</p>
        <p class="footer-hours-secondary">Sat: 8:00 AM – 2:00 PM</p>
      </div>
    </div>
  </div>
